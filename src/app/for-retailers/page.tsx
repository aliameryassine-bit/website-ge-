                ...
                <tr>
                  {COPY_R.deployment.placementColumns.map((column) => (
                    <th
                      key={column}
                      scope="col"
                      className="border-b border-alu/40 py-sm pr-lg align-bottom text-label text-ink-muted uppercase"
                    >
                      {column}
                    </th>
                  ))}
              ...
              <tbody>
                {COPY_R.deployment.placements.map((row) => (
                  <tr key={row.name}>
                    <th
                      scope="row"
                      className="border-b border-alu/20 py-md pr-lg align-top text-body text-ink"
                    >
                      {row.name}
                    </th>
                    {[row.space, row.weather, row.footfall, row.servicing, row.power].map(
                      (cell, index) => (
                        <td
                          key={index}
                          className="border-b border-alu/20 py-md pr-lg align-top text-body text-ink-muted"
                        >
                          {cell}
                        </td>
                      ),
